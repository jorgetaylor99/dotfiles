...
" Disable the Q shortcut (Ex mode)
nmap Q <Nop>
...
" Prevent issues with backup files
set nobackup
set nowritebackup

" Reduce updatetime for a better user experience
set updatetime=300

" Always show the signcolumn
set signcolumn=auto

" Autocomplete and navigation settings using TAB
...
" Make Enter key select autocomplete suggestion
